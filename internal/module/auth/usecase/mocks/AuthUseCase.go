...
func (_m *MockAuthUseCase) Login(ctx context.Context, username string, password string) (*domain.User, string, error) {
...
func (_c *MockAuthUseCase_Login_Call) Return(_a0 *domain.User, _a1 string, _a2 error) *MockAuthUseCase_Login_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockAuthUseCase_Login_Call) RunAndReturn(run func(context.Context, string, string) (*domain.User, string, error)) *MockAuthUseCase_Login_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - ctx context.Context
//   - token string
func (_e *MockAuthUseCase_Expecter) Logout(ctx interface{}, token interface{}) *MockAuthUseCase_Logout_Call {
