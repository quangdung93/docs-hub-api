...
// @Router /internal/api/v1/projects/{project_id}/documents/uploads [post]
func (h *Handler) Upload(c *gin.Context) {
	h.upload(c, uuid.Nil)
}

func (h *Handler) upload(c *gin.Context, pathDocumentID uuid.UUID) {
	pid, ok := pathID(c, "project_id")
	if !ok {
		return
	}
	did := pathDocumentID
...
// @Failure 401 {object} response.Envelope
// @Failure 403 {object} response.Envelope
// @Router /internal/api/v1/projects/{project_id}/documents/uploads/presign [post]
...
// @Failure 401 {object} response.Envelope
// @Failure 403 {object} response.Envelope
// @Router /internal/api/v1/projects/{project_id}/documents/uploads/{upload_id}/complete [post]
...
// @Failure 401 {object} response.Envelope
// @Failure 403 {object} response.Envelope
// @Router /internal/api/v1/projects/{project_id}/documents [get]
...
// @Router /internal/api/v1/projects/{project_id}/documents/{id} [get]
...
// @Failure 401 {object} response.Envelope
// @Failure 403 {object} response.Envelope
// @Router /internal/api/v1/projects/{project_id}/documents/{id} [patch]
...
// @Failure 401 {object} response.Envelope
// @Failure 403 {object} response.Envelope
// @Router /internal/api/v1/projects/{project_id}/documents/{id}/revisions [post]
...
// @Failure 403 {object} response.Envelope
// @Failure 404 {object} response.Envelope
// @Router /internal/api/v1/projects/{project_id}/documents/{id}/revisions/{revision_id}/status [get]
...
// @Failure 401 {object} response.Envelope
// @Failure 403 {object} response.Envelope
// @Router /internal/api/v1/projects/{project_id}/documents/{id}/revisions/{revision_id}/retry [post]
...
// @Failure 403 {object} response.Envelope
// @Failure 404 {object} response.Envelope
// @Router /internal/api/v1/projects/{project_id}/documents/{id}/revisions/{revision_id}/download [get]
...
// @Failure 403 {object} response.Envelope
// @Failure 404 {object} response.Envelope
// @Router /internal/api/v1/projects/{project_id}/documents/{id}/revisions/{revision_id}/view [get]
...
// @Failure 403 {object} response.Envelope
// @Failure 404 {object} response.Envelope
// @Router /internal/api/v1/projects/{project_id}/documents/{id} [delete]
