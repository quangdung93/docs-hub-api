...
func (_m *MockCache) Del(ctx context.Context, keys ...string) error {
...
func (_m *MockCache) Incr(ctx context.Context, key string, ttl time.Duration) (int64, error) {
...
//   - key string
//   - ttl time.Duration
func (_e *MockCache_Expecter) Incr(ctx interface{}, key interface{}, ttl interface{}) *MockCache_Incr_Call {
	return &MockCache_Incr_Call{Call: _e.mock.On("Incr", ctx, key, ttl)}
}

func (_c *MockCache_Incr_Call) Run(run func(ctx context.Context, key string, ttl time.Duration)) *MockCache_Incr_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockCache_Incr_Call) RunAndReturn(run func(context.Context, string, time.Duration) (int64, error)) *MockCache_Incr_Call {
	_c.Call.Return(run)
	return _c
}
