...
CREATE INDEX IF NOT EXISTS idx_chunks_project_scope ON document_chunks(project_id, project_version_id, change_request_id);
CREATE INDEX IF NOT EXISTS idx_chunks_revision ON document_chunks(document_revision_id);
